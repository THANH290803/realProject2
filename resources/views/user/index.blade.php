...
<style>
    ...
    /*!* Định dạng phần tử .add-actions *!*/
    /*.add-actions {*/
    /*    text-align: center; !* Căn giữa nội dung *!*/
    /*}*/

    /*!* Định dạng phần tử .add-actions-link *!*/
    /*.add-actions-link {*/
    /*    display: inline-block;*/
    /*    margin: 10px; !* Khoảng cách giữa nút và nội dung xung quanh *!*/
    /*}*/

    /*!* Định dạng nút "ADD TO CART" với chữ in hoa *!*/
    /*.add-cart button {*/
    /*    background-color: #eef0f1; !* Màu nền *!*/
    /*    color: black; !* Màu văn bản *!*/
    /*    border: none; !* Loại bỏ viền *!*/
    /*    font-weight: 500;*/
    /*    font-size: 13px;*/
    /*    padding: 8px 8px; !* Kích thước nút *!*/
    /*    margin-bottom: 12px;*/
    /*    border-radius: 6px; !* Góc bo tròn *!*/
    /*    cursor: pointer; !* Hiển thị cursor là pointer khi di chuột qua nút *!*/
    /*    transition: background-color 0.3s ease; !* Hiệu ứng màu nền thay đổi mượt mà *!*/
    /*    width: 230px; !* Đặt độ rộng cho nút *!*/
    /*    text-transform: uppercase; !* In hoa toàn bộ văn bản trong nút *!*/
    /*}*/


    /*!* Định dạng khi di chuột qua nút *!*/
    /*.add-cart button:hover {*/
    /*    background-color: #FFD700; !* Màu nền khi di chuột qua *!*/
    /*}*/

    /*!* Định dạng khi nút được nhấn *!*/
    /*.add-cart button:active {*/
    /*    background-color: #FFD700; !* Màu nền khi nút được nhấn *!*/
    /*}*/

    /*!* Định dạng nút khi nó bị vô hiệu hóa *!*/
    /*.add-cart button[disabled] {*/
    /*    background-color: #ccc; !* Màu nền khi nút bị vô hiệu hóa *!*/
    /*    cursor: not-allowed; !* Hiển thị cursor là not-allowed khi nút bị vô hiệu hóa *!*/
    /*}*/
...
<div class="body-wrapper">
                                ...
                                <li class="hm-minicart">
                                    ...
                                    <div class="minicart">
                                        <div class="minicart-button">
                                            <a href="{{route('user.cart')}}" class="li-button li-button-dark li-button-fullwidth li-button-sm">
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="slider-active owl-carousel">
                            ...
                            <div class="single-slide align-center-left animation-style-01 bg-3">
                                ...
                                <div class="slider-content">
                                    ...
                                    <h3>Starting at <span>$1305.00</span></h3>
                                    <div class="default-btn slide-btn">
                                        <a class="links" href="shop-left-sidebar.html">Shopping Now</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-4 text-center pt-sm-30 pt-xs-30">
                    <div class="li-banner">
                        <a href="#">
                            <img src="images/banner/banner-phu-kien-home-banner-nho.png" alt="" style="height: 230px; width: 370px;">
                        </a>
                    </div>
                    <div class="li-banner mt-15 mt-md-30 mt-xs-25 mb-xs-5">
                        <a href="#">
                            <img src="images/banner/HEAD-apple-chinhhang.png" alt="" style="height: 230px; width: 370px;">
                        </a>
                    </div>
                </div>
    ...
    <!-- product-area start -->
    <div class="product-area pb-25 pt-xs-50">
        <div class="container">
{{--            <div class="row">--}}
{{--                <div class="col-lg-12">--}}
{{--                    <div class="li-product-tab">--}}
{{--                        <ul class="nav li-product-menu">--}}
{{--                            <li><a class="active" data-toggle="tab" href="#li-new-product"><span>All Products</span></a></li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
...
{{--                                                <form method="post" action="{{ route('cart.add', ['productId' => $product->id]) }}" class="add-cart active">--}}
{{--                                                    @csrf--}}
{{--                                                    <button href="shopping-cart.html">Add to cart</button>--}}
{{--                                                </form>--}}
{{--                                            </div>--}}
                                            <div class="add-actions">
