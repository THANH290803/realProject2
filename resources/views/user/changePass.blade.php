...
<style>
    ...
    .save-button:active {
        background-color: #1f6aa9; /* Màu nền khi nút được nhấn */
    }

    /* Định dạng nút khi nó được vô hiệu hóa */
                        ...
                        <div class="header-middle-right">
                            <ul class="hm-menu">
                                ...
                                <li class="hm-minicart">
                                    <div href="{{asset('user/cart')}}" class="hm-minicart-trigger">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-4 col-sm-6 mt-40">
                                            <div class="secce-box">
                                                ...
                                                <p>Please change the password as you wish</p> <hr>
                                                <div class="card-body">
                                                    <div id="container"><div id="container-inner">
                                                            ...
                                                            <form action="{{ route('user.changePassword') }}" method="post">
                                                                ...
                                                                <fieldset>
                                                                    ...
                                                                    <!-- Controls -->
                                                                    <div class="form-group" style="display: flex; justify-content: flex-end; margin-top: 25px">
