            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="single-banner shop-page-banner">
                        <a href="#">
                            <img src="{{  asset('user/images/bg-banner/mac-banner.png') }}" alt="Li's Static Banner" style="width: 1170px; height: 269px;">
                        </a>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <ul class="pagination-box">
                                            @if ($laptopProducts->previousPageUrl())
                                                <li><a href="{{ $laptopProducts->previousPageUrl() }}" class="Previous"><i class="fa fa-chevron-left"></i> Previous</a></li>
                                            @else
                                                <li class="disabled"><span class="Previous"><i class="fa fa-chevron-left"></i> Previous</span></li>
                                            @endif

                                            @foreach ($laptopProducts->getUrlRange(1, $laptopProducts->lastPage()) as $page => $url)
                                                <li class="{{ $laptopProducts->currentPage() == $page ? 'active' : '' }}">
                                                    <a href="{{ $url }}">{{ $page }}</a>
                                                </li>
                                            @endforeach

                                            @if ($laptopProducts->nextPageUrl())
                                                <li><a href="{{ $laptopProducts->nextPageUrl() }}" class="Next">Next <i class="fa fa-chevron-right"></i></a></li>
                                            @else
